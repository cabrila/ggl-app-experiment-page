      ...
      <div className="flex items-start gap-4 mb-4">
        ...
        {onToggleSelect && (
          <button
            ...
            className={`w-5 h-5 mt-1 rounded border-2 flex items-center justify-center transition-all flex-shrink-0 ${
              isSelected ? "bg-violet-500 border-violet-500 text-white" : "border-white/30 hover:border-violet-400 bg-transparent"
            }`}
