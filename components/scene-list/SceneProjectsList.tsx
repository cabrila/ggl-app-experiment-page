...
export default function SceneProjectsList() {
  const { projects, setView, setCurrentProject, deleteProject, updateProject, setPendingScript } = useSceneList()
  ...
  const handleDelete = (e: React.MouseEvent, project: SceneProject) => {
    e.stopPropagation()
  ...
  return (
    <div className="h-full overflow-y-auto p-6 md:p-10">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-white font-sans mb-2">My Scenes</h1>
          <p className="text-white/60 text-base font-sans">
            Break down scripts into scenes for scheduling, planning, and shot lists.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {projects.map((project) => (
            <div
              ...
              className="group relative flex rounded-xl border border-white/10 bg-[#1a2e23] hover:border-teal-500/50 transition-all overflow-hidden"
            >
              ...
              >
                ...
                <div className="mb-2 pr-16">
                  <h3 className="text-base font-bold text-white font-sans leading-snug break-words line-clamp-2">{project.name}</h3>
                  {project.isDemo && (
                ...
                <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-white/50">
                  <div className="flex items-center gap-1 min-w-0">
                    ...
                    <span className="truncate">{project.scenes.length} scenes</span>
                  </div>
                  <div className="flex items-center gap-1 min-w-0">
          ...
          >
            ...
            <span className="text-white/50 font-sans font-medium">New Scene Breakdown</span>
          </button>
        </div>
        ...
        <DeleteConfirmationModal
          ...
          title="Delete Scene Breakdown"
          itemName={deleteTarget?.name || ""}
          description="This will permanently delete this scene breakdown and all its scenes. This action cannot be undone."
        />
