...
{isValidImageUrl(item.imageUrl) ? (
        ...
        <input autoComplete="off" ref={fileInputRef} type="file" accept="image/*" className="hidden" onChange={(e) => { handleFiles(e.target.files); e.target.value = "" }} />
...
{isValidImageUrl(imageUrl) ? (
            ...
            <input autoComplete="off" ref={imgInputRef} type="file" accept="image/*" className="hidden" onChange={(e) => { if (e.target.files?.[0]) handleImgUpload(e.target.files[0]) }} />
          </div>
          ...
          <div className="mb-5">
            ...
            <textarea autoComplete="off" value={notes} onChange={(e) => setNotes(e.target.value)} rows={2} className="w-full px-3 py-2 text-sm border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-1 focus:ring-rose-300 resize-none" />
          </div>
      ...
      <div className="bg-white rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden shadow-2xl flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="mb-4">
            ...
            <textarea autoComplete="off" value={continuityNotes} onChange={(e) => setContinuityNotes(e.target.value)} rows={2} placeholder="Top button undone, mud on left boot..." className="w-full px-3 py-2 text-sm border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-1 focus:ring-rose-300 resize-none" />
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="relative w-48">
                ...
                <input autoComplete="off" value={searchInv} onChange={(e) => setSearchInv(e.target.value)} placeholder="Search inventory..." className="w-full pl-7 pr-2 py-1 text-xs border border-gray-200 rounded-lg bg-white focus:outline-none focus:ring-1 focus:ring-rose-300" />
              </div>
            </div>
